...
tools: Agent(Plan, Explore, Implementor, OutputSummarizer), Bash, Read, Edit, Write, Skill, TaskCreate, TaskUpdate, TaskList, TaskGet, EnterWorktree, ExitWorktree, EnterPlanMode
model: opus
effort: high
memory: project
---
